############################################################################
############################################################################
## Author: Benjamin Wittenbrink
## File: covid_graphs.R
## Date: 27/05/2020
## Description: Process Stanford/SC county COVID data to produce graphs for Stanford Daily article 
## "A Closer Look at COVID-19 Testing in Stanford Hospital and Santa Clara County"
############################################################################
############################################################################
